...
% \usepackage{sectsty}         % for styling section
\usepackage[normalem]{ulem}  % with double underline


\definecolor{accent_color}{HTML}{04567F} % nice blue
...
% put underline below section http://tex.stackexchange.com/q/167857/
